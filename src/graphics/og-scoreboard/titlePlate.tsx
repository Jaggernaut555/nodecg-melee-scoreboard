...
function TitlePlate(props: titlePlateProps) {
    ...
    useEffect(() => {
        if (isAnimating || (props.keepHidden && isHidden) || (isHidden && !props.title)) {
            return;
        }
        ...
        else if ((props.title != displayedTitle && isHidden) || (!props.keepHidden && isHidden)) {
            setIsAnimating(true);
            setDisplayedTitle(props.title);
            anime({
                // show score
    ...
    useEffect(() => {
        if (isAnimatingSubtitle || (props.keepHidden && isHiddenSubtitle) || (isHiddenSubtitle && !props.subtitle)) {
            return;
        }
        ...
        else if ((props.subtitle != displayedSubtitle && isHiddenSubtitle) || (!props.keepHidden && isHiddenSubtitle)) {
            setIsAnimatingSubtitle(true);
            setDisplayedSubtitle(props.subtitle);
            setSubtitleAnimationRef(
                anime({
    ...
    return (
        <div className="sc_titleBox hidden">
            <div className="title color3" id="game_1">{displayedTitle}</div>
            <div className="sc_subtitleBox hidden">
                <div className="subtitle color1" id="round_1">{displayedSubtitle}</div>
            </div>
        </div>
    )
}
